...
export class createTableRelationship1727654289658 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!(await constraintExists('FK_4175c832d328c98ebafbc82aa95'))) {
    ...
    if (!(await constraintExists('FK_de65040d842349a5e6428ff21e6'))) {
      await queryRunner.query(
    ...
    if (!(await constraintExists('FK_982f19c6e0628e9d5ba8132ec67'))) {
      await queryRunner.query(
    ...
    if (!(await constraintExists('FK_f1c8ff871433d51c817a17234de'))) {
      await queryRunner.query(
    ...
    if (!(await constraintExists('FK_259b5a2e24d0a5480262a774e46'))) {
      await queryRunner.query(
    ...
    if (!(await constraintExists('FK_ed1bb3304475cfa49b2964aaf27'))) {
      await queryRunner.query(
