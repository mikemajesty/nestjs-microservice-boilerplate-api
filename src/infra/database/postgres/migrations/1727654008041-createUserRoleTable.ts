...
export class createUserRoleTable1727654008041 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_259b5a2e24d0a5480262a774e4" ON "users_roles"("users_id") `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_ed1bb3304475cfa49b2964aaf2" ON "users_roles"("roles_id")`);
  }
