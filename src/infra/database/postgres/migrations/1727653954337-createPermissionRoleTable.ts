...
export class createPermissionRoleTable1727653954337 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_982f19c6e0628e9d5ba8132ec6" ON "permissions_roles" ("roles_id")`);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_f1c8ff871433d51c817a17234d" ON "permissions_roles" ("permissions_id")`);
  }
