...
SMOKE_INGRESS ?= $(PROJECT)-$(ENVIRONMENT)-boilerplate-app-public-ingress
...
K8S_CLEANUP_NAMESPACES ?= $(WORKLOAD_NAMESPACE) $(ARGOCD_NAMESPACE) cert-manager envoy-gateway-system external-secrets karpenter
