...
async function bootstrap() {
    ...
    app.useGlobalInterceptors(new http_exception_interceptor_1.ExceptionInterceptor(), new http_logger_interceptor_1.HttpLoggerInterceptor(), new http_tracing_interceptor_1.HttpTracingInterceptor(loggerService));
