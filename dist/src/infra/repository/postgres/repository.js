...
class SequelizeRepository {
    ...
    async findOneWithIncludeFields(filter, includeProperties, options) {
        const { schema } = sequelize_2.DatabaseOptionsSchema.parse(options);
    ...
    async findAllWithIncludeFields(includeProperties, filter, options) {
        const { schema } = sequelize_2.DatabaseOptionsSchema.parse(options);
        const include = includeProperties.map((e) => `${e.toString()}`);
        Object.assign(filter || {}, { deletedAt: null });
        const model = await this.Model.schema(schema).findAll({
...
__decorate([
    (0, convert_sequelize_filter_decorator_1.ConvertSequelizeFilterToRepository)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array, typeof (_s = typeof TQuery !== "undefined" && TQuery) === "function" ? _s : Object, typeof (_t = typeof TOptions !== "undefined" && TOptions) === "function" ? _t : Object]),
    __metadata("design:returntype", Promise)
], SequelizeRepository.prototype, "findAllWithExcludeFields", null);
__decorate([
    (0, convert_sequelize_filter_decorator_1.ConvertSequelizeFilterToRepository)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_u = typeof TQuery !== "undefined" && TQuery) === "function" ? _u : Object, Array, typeof (_v = typeof TOptions !== "undefined" && TOptions) === "function" ? _v : Object]),
    __metadata("design:returntype", Promise)
], SequelizeRepository.prototype, "findOneWithIncludeFields", null);
__decorate([
    (0, convert_sequelize_filter_decorator_1.ConvertSequelizeFilterToRepository)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array, typeof (_w = typeof TQuery !== "undefined" && TQuery) === "function" ? _w : Object, typeof (_x = typeof TOptions !== "undefined" && TOptions) === "function" ? _x : Object]),
    __metadata("design:returntype", Promise)
], SequelizeRepository.prototype, "findAllWithIncludeFields", null);
