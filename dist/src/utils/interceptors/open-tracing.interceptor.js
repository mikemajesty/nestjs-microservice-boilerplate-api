...
exports.OpenTracingInterceptor = void 0;
...
let OpenTracingInterceptor = class OpenTracingInterceptor {
    constructor(logger) {
        this.logger = logger;
...
OpenTracingInterceptor = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [logger_1.ILoggerAdapter])
], OpenTracingInterceptor);
exports.OpenTracingInterceptor = OpenTracingInterceptor;
//# sourceMappingURL=open-tracing.interceptor.js.map